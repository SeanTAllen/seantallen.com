...
summary: "How conversations with Kathy Sierra changed the way I think about teaching and writing Storm Applied."
---
...
![Definition of web-scale from Storm Applied](Definition-of-web-scale-from-Storm-Applied.png)
...
![Example Storm UI screenshot from Storm Applied](Storm-UI-Figure-from-Storm-Applied.png)
